        ...
        <Stack className="absolute bottom-[0] h-[1529px] inset-x-[0] mx-[auto] w-[100%]">
          ...
          <Stack className="absolute bg-gray_900_87 h-[1024px] inset-x-[0] mx-[auto] p-[208px] sm:px-[20px] md:px-[40px] top-[0] w-[100%]">
                        ...
                        <div className="flex flex-col items-start justify-start sm:w-[100%] w-[auto]">
                          <div className="flex flex-col gap-[8px] items-start justify-start sm:w-[100%] w-[auto]">
                            ...
                            <div className="border border-gray_900_19 border-solid flex flex-row sm:gap-[40px] items-center justify-between pl-[16px] rounded-radius8 w-[100%]">
                              ...
                              <div className="border border-gray_202 border-solid flex flex-col items-center justify-start p-[8px] rounded-bl-[0] rounded-br-[8px] rounded-tl-[0] rounded-tr-[8px] w-[12%]">
                                <Img
                                  src="images/img_volume_gray_900.svg"
                                  className="h-[24px] my-[3px] w-[46px]"
                                  alt="volume One"
                                />
                              </div>
                            </div>
            ...
            <div className="absolute bottom-[20%] flex flex-col inset-x-[0] items-center justify-start mx-[auto] shadow-bs w-[38%]">
              <div
                className="bg-cover bg-no-repeat flex flex-col items-center justify-end pt-[11px] px-[11px] w-[100%]"
                style={{ backgroundImage: "url('images/img_group602.svg')" }}
              >
                <div className="flex sm:flex-col flex-row sm:gap-[40px] items-start justify-between md:w-[100%] sm:w-[100%] w-[97%]">
                  <Img
                  ...
                  <div className="flex flex-col gap-[16px] items-start justify-start sm:mt-[0] mt-[19px] md:w-[100%] sm:w-[100%] w-[47%]">
                    <Img
                      src="images/img_group595.png"
                      className="h-[180px] md:h-[auto] sm:h-[auto] object-cover sm:w-[100%] w-[auto]"
                      alt="Group595"
                    />
