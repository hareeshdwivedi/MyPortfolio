              ...
              <div className="absolute flex flex-col h-[max-content] inset-[0] items-center justify-center m-[auto] w-[100%]">
                <div className="flex flex-col gap-[24px] items-center justify-start w-[100%]">
                  ...
                  <div className="flex md:flex-col sm:flex-col flex-row gap-[8px] items-start justify-start md:w-[100%] sm:w-[100%] w-[96%]">
                    <Stack className="h-[532px] relative md:w-[100%] sm:w-[100%] w-[20%]">
                      <div className="absolute bg-gray_900_0a flex flex-col gap-[8px] inset-x-[0] items-center justify-start mx-[auto] py-[8px] rounded-radius8 top-[0] w-[auto]">
                            ...
                            <div className="flex flex-col gap-[8px] items-center justify-start md:w-[100%] sm:w-[100%] w-[93%]">
                              ...
                              <div className="flex flex-col gap-[8px] items-center justify-start w-[100%]">
                                ...
                                <div className="flex flex-row gap-[8px] items-center justify-start w-[200px]">
                                  <div className="bg-white_A700 border border-gray_900_19 border-solid flex flex-col justify-center px-[8px] py-[7px] rounded-radius6 sm:w-[100%] w-[139px]">
                                    <SelectBox
                                      className="font-normal sm:mx-[0] not-italic text-[12px] text-gray_900_7e text-left w-[100%]"
                      ...
                      <div className="absolute bottom-[0] flex flex-col items-center justify-start left-[4%] w-[78%]">
                        <div className="bg-white_A700 border border-gray_900_19 border-solid flex flex-col items-center justify-start rounded-radius8 shadow-bs w-[100%]">
                          <div className="flex flex-col items-start justify-start my-[7px] w-[auto]">
                            <div className="flex flex-col items-start justify-center p-[8px] w-[166px]">
                            ...
                            <div className="bg-gray_900_0a flex flex-row gap-[6px] items-center justify-start p-[8px] w-[166px]">
                            ...
                            <div className="flex flex-row gap-[6px] items-center justify-start p-[8px] w-[166px]">
