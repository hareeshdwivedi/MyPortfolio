...
const CardFilterwithspacecoPage = () => {
          ...
          <div className="flex flex-col items-center justify-start md:pl-[20px] sm:pl-[20px] md:pr-[20px] sm:pr-[20px] md:w-[100%] sm:w-[100%] w-[82%]">
            ...
            <div className="flex flex-col items-center justify-start w-[100%]">
              <div className="flex flex-col gap-[24px] items-center justify-start w-[100%]">
                ...
                <div className="flex md:flex-col sm:flex-col flex-row md:gap-[8px] sm:gap-[8px] items-start justify-between md:w-[100%] sm:w-[100%] w-[98%]">
                  <div className="bg-gray_100 flex flex-col gap-[8px] items-center justify-start mb-[502px] py-[8px] rounded-radius8 w-[auto]">
                  ...
                  <Stack className="h-[826px] relative md:w-[100%] sm:w-[100%] w-[39%]">
                    <div className="flex flex-col items-center justify-start m-[auto] w-[100%]">
                      <div className="flex sm:flex-col flex-row sm:gap-[8px] items-start justify-between w-[100%]">
                        <div className="bg-gray_101 flex flex-col gap-[8px] items-center justify-start mb-[163px] py-[8px] rounded-radius8 w-[auto]">
                          <div className="flex flex-row items-center justify-between w-[192px]">
                            <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                              <Text
                                className="font-semibold text-gray_900 text-left w-[auto]"
                        ...
                        <div className="flex flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[50%]">
                          <Stack className="bg-gray_101 h-[826px] md:h-[auto] sm:h-[auto] py-[8px] relative rounded-radius8 w-[216px]">
                            <Stack className="bg-gray_101 h-[826px] md:h-[auto] sm:h-[auto] m-[auto] py-[8px] rounded-radius8 w-[216px]">
                              ...
                              <div className="absolute bg-gray_101 flex flex-col h-[34px] md:h-[auto] sm:h-[auto] inset-x-[0] items-center justify-end mx-[auto] px-[12px] py-[8px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] top-[0] w-[auto]">
                                <div className="flex flex-row items-center justify-between w-[192px]">
                                  <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                                    <Text
                                      className="font-semibold text-gray_900 text-left w-[auto]"
                            ...
                            <div className="absolute bottom-[0] flex flex-col gap-[8px] inset-x-[0] items-center justify-start mx-[auto] w-[auto]">
                              ...
                              <div className="flex flex-col md:gap-[40px] sm:gap-[40px] gap-[62px] items-center justify-start w-[100%]">
                                <Stack className="h-[55px] px-[8px] relative w-[216px]">
                                  ...
                                  <div className="absolute bg-gray_101 bottom-[0] flex flex-col h-[50px] md:h-[auto] sm:h-[auto] inset-x-[0] items-center justify-start mx-[auto] px-[12px] py-[8px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] w-[216px]">
                                ...
                                <List
                                  className="flex-col gap-[185px] md:gap-[40px] sm:gap-[40px] grid items-center w-[100%]"
                                  orientation="vertical"
                                >
                                  <div className="flex flex-col items-start justify-start px-[8px] w-[216px]">
                    ...
                    <div className="absolute bg-white_A700 flex flex-col gap-[15px] inset-x-[0] items-center justify-start mx-[auto] rounded-radius8 shadow-bs top-[4%] w-[65%]">
                      <div className="bg-white_A700 border border-gray_900_19 border-solid flex flex-col items-center justify-start p-[15px] rounded-bl-[0] rounded-br-[0] rounded-tl-[7px] rounded-tr-[7px] w-[100%]">
                        <div className="flex flex-row items-center justify-between w-[254px]">
                          <Text
                      ...
                      <Stack className="h-[620px] relative w-[100%]">
                        <div className="absolute flex flex-row h-[max-content] inset-y-[0] items-center justify-between my-[auto] right-[1%] w-[94%]">
                          <div className="flex flex-col gap-[16px] items-start justify-start w-[auto]">
                              ...
                              <div className="flex flex-col items-start justify-start w-[auto]">
                                <div className="flex flex-col gap-[12px] items-start justify-start w-[auto]">
                                  <div className="flex flex-row gap-[12px] items-center justify-start w-[auto]">
                                    <div className="bg-light_blue_A700 flex flex-col h-[18px] items-center justify-start rounded-radius4 w-[18px]">
                                      <Img
                            ...
                            <div className="flex flex-col gap-[16px] items-start justify-start w-[auto]">
                              ...
                              <div className="flex flex-col items-start justify-start w-[auto]">
                                <div className="flex flex-col gap-[12px] items-start justify-start w-[auto]">
                                  <CheckBox
                                    className="font-normal leading-[normal] not-italic p-[0] text-[10px] text-gray_900_a2 text-left w-[100%]"
                                    inputClassName="h-[18px] mr-[5px] w-[18px]"
                                    name="apicontactrmcom"
                                  ...
                                  <div className="flex flex-row gap-[12px] items-center justify-start w-[auto]">
                                    <div className="border border-gray_900_26 border-solid h-[18px] rounded-radius4 w-[18px]"></div>
                                    <Text
                                      className="bg-purple_51 font-normal not-italic px-[6px] py-[2px] rounded-radius8 text-gray_900_a2 text-left w-[auto]"
                                      variant="body3"
                                    >
                                      api.contactrm
                                    </Text>
                                  ...
                                  <div className="flex flex-row gap-[12px] items-center justify-start w-[auto]">
                                    <div className="border border-gray_900_26 border-solid h-[18px] rounded-radius4 w-[18px]"></div>
                                    <Text
                                      className="bg-blue_51 font-normal not-italic px-[6px] py-[2px] rounded-radius8 text-gray_900_a2 text-left w-[auto]"
                                      variant="body3"
                                    >
                                      Restrictive APIs
                                    </Text>
                                  ...
                                  <div className="flex flex-row gap-[12px] items-center justify-start w-[auto]">
                                    <div className="border border-gray_900_26 border-solid h-[18px] rounded-radius4 w-[18px]"></div>
                                    <Text
                                      className="bg-blue_52 font-normal not-italic px-[6px] py-[2px] rounded-radius9 text-gray_900_a2 text-left w-[auto]"
                                      variant="body3"
                                    >
                                      api.agentbook.com
                                    </Text>
                              ...
                              <div className="flex flex-col gap-[12px] items-start justify-start w-[auto]">
                                ...
                                >
                                  <div className="flex flex-row gap-[12px] items-center justify-start w-[auto]">
                                    ...
                                    <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                                      <Img
                                        src="images/img_ellipse45_1.png"
                                        className="h-[24px] md:h-[auto] sm:h-[auto] rounded-radius50 w-[24px]"
                          ...
                          <Line className="bg-bluegray_200 h-[128px] mb-[248px] mt-[244px] rounded-radius2 w-[4px]" />
                        </div>
                        <div className="absolute bg-white_A700 border border-gray_900_14 border-solid bottom-[0] flex flex-col inset-x-[0] items-end justify-start mx-[auto] p-[12px] rounded-bl-[8px] rounded-br-[8px] rounded-tl-[0] rounded-tr-[0] w-[100%]">
                          <div className="flex flex-col items-center justify-start mr-[4px] md:w-[100%] sm:w-[100%] w-[52%]">
                            <div className="flex flex-row gap-[4px] items-center justify-start w-[auto]">
                              <div className="bg-white_A700 flex flex-col items-start justify-center px-[12px] py-[6px] rounded-radius8 w-[auto]">
                                <div className="flex flex-col items-start justify-center w-[auto]">
                                  <Text
                                    className="font-medium text-gray_900_87 text-left w-[auto]"
                                    as="h5"
                              ...
                              <div className="bg-light_blue_A700 border border-gray_900_0c border-solid flex flex-col items-start justify-center px-[16px] py-[8px] rounded-radius8 w-[auto]">
                                <div className="flex flex-col items-start justify-center w-[auto]">
                                  <Text
                  ...
                  <div className="bg-gray_101 flex flex-col gap-[8px] items-center justify-start mb-[133px] py-[8px] rounded-radius8 w-[auto]">
                    <div className="flex flex-row items-center justify-between w-[192px]">
                      <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                        <Text
                          className="font-semibold text-gray_900 text-left w-[auto]"
                  ...
                  <div className="flex flex-col gap-[149px] md:gap-[40px] sm:gap-[40px] justify-start md:w-[100%] sm:w-[100%] w-[22%]">
                    <div className="bg-gray_101 flex flex-col gap-[8px] items-center justify-start mr-[29px] py-[8px] rounded-radius8 w-[auto]">
                      <div className="flex flex-row items-center justify-between w-[192px]">
                        <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                          <Text
                            className="font-semibold text-gray_900 text-left w-[auto]"
                    ...
                    <div className="flex flex-col gap-[8px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[213px] w-[auto]">
...
export default CardFilterwithspacecoPage;
