...
import { Img, Text, Line, Button, Input, List, Stack } from "components";
import { CloseSVG } from "../../assets/images/index.js";

const SortbyPopupwithspacePage = () => {
            ...
            <div className="flex flex-col items-center justify-start w-[100%]">
              <div className="flex flex-col gap-[24px] items-center justify-start w-[100%]">
                    ...
                    <div className="flex sm:flex-col flex-row gap-[24px] items-center justify-start sm:w-[100%] w-[auto]">
                      ...
                      <div className="flex flex-row gap-[20px] items-start justify-start w-[auto]">
                        <div className="flex flex-row gap-[4px] items-center justify-start w-[auto]">
                          ...
                          >
                            <Img
                              src="images/img_component28.svg"
                              className="h-[18px] w-[18px]"
                ...
                <div className="flex md:flex-col sm:flex-col flex-row md:gap-[8px] sm:gap-[8px] items-start justify-between md:w-[100%] sm:w-[100%] w-[98%]">
                  <div className="bg-gray_201 flex flex-col gap-[8px] items-center justify-start mb-[502px] py-[8px] rounded-radius8 w-[auto]">
                  ...
                  <Stack className="h-[826px] relative md:w-[100%] sm:w-[100%] w-[39%]">
                    <div className="flex flex-col items-center justify-start m-[auto] w-[100%]">
                      <div className="flex sm:flex-col flex-row sm:gap-[8px] items-start justify-between w-[100%]">
                        <div className="bg-gray_201 flex flex-col gap-[8px] items-center justify-start mb-[163px] py-[8px] rounded-radius8 w-[auto]">
                          <div className="flex flex-row items-center justify-between w-[192px]">
                            <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                              <Text
                                className="font-semibold text-gray_900 text-left w-[auto]"
                        ...
                        <div className="bg-gray_201 flex flex-col items-center justify-start rounded-radius8 md:w-[100%] sm:w-[100%] w-[50%]">
                          <Stack className="bg-gray_201 h-[826px] md:h-[auto] sm:h-[auto] py-[8px] relative rounded-radius8 w-[216px]">
                            <Stack className="bg-gray_201 h-[826px] md:h-[auto] sm:h-[auto] m-[auto] py-[8px] rounded-radius8 w-[216px]">
                              ...
                              <div className="absolute bg-gray_201 flex flex-col h-[34px] md:h-[auto] sm:h-[auto] inset-x-[0] items-center justify-end mx-[auto] px-[12px] py-[8px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] top-[0] w-[auto]">
                                <div className="flex flex-row items-center justify-between w-[192px]">
                                  <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                                    <Text
                                      className="font-semibold text-gray_900 text-left w-[auto]"
                            ...
                            <div className="absolute bottom-[0] flex flex-col gap-[8px] inset-x-[0] items-center justify-start mx-[auto] w-[auto]">
                              ...
                              <div className="flex flex-col items-center justify-start w-[100%]">
                                <Stack className="h-[55px] px-[8px] relative w-[216px]">
                                  ...
                                  <div className="absolute bg-gray_201 bottom-[0] flex flex-col h-[50px] md:h-[auto] sm:h-[auto] inset-x-[0] items-center justify-start mx-[auto] px-[12px] py-[8px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] w-[216px]">
                    ...
                    <div className="absolute bg-white_A700 border border-gray_900_19 border-solid flex flex-col gap-[9px] inset-x-[0] items-center justify-start mx-[auto] rounded-radius8 shadow-bs top-[4%] w-[55%]">
                  ...
                  <div className="bg-gray_201 flex flex-col gap-[8px] items-center justify-start mb-[133px] py-[8px] rounded-radius8 w-[auto]">
                    <div className="flex flex-row items-center justify-between w-[192px]">
                      <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                        <Text
                          className="font-semibold text-gray_900 text-left w-[auto]"
                  ...
                  <div className="flex flex-col gap-[149px] md:gap-[40px] sm:gap-[40px] justify-start md:w-[100%] sm:w-[100%] w-[22%]">
                    <div className="bg-gray_201 flex flex-col gap-[8px] items-center justify-start mr-[29px] py-[8px] rounded-radius8 w-[auto]">
                      <div className="flex flex-row items-center justify-between w-[192px]">
                        <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                          <Text
                            className="font-semibold text-gray_900 text-left w-[auto]"
...
export default SortbyPopupwithspacePage;
