          ...
          <div className="flex flex-col items-center justify-start md:pl-[20px] sm:pl-[20px] md:pr-[20px] sm:pr-[20px] md:w-[100%] sm:w-[100%] w-[82%]">
            ...
            <Stack className="h-[918px] relative w-[100%]">
              ...
              <Stack className="absolute h-[918px] inset-[0] justify-center m-[auto] w-[100%]">
                ...
                <div className="absolute bg-bluegray_50 border border-gray_900_19 border-solid flex flex-col items-center justify-start right-[25%] rounded-radius8 shadow-bs top-[7%] w-[26%]">
                  <div className="flex flex-col gap-[16px] items-end justify-start w-[100%]">
                    <div className="bg-white_A700 flex flex-col items-center justify-end rounded-bl-[0] rounded-br-[0] rounded-tl-[7px] rounded-tr-[7px] w-[100%]">
                      <div className="flex flex-col items-center justify-start mt-[9px] w-[100%]">
                              ...
                              <div className="flex flex-col items-center justify-start w-[51%]">
                                <div className="flex flex-col items-center justify-start w-[100%]">
                                  <Button
                                    ...
                                    leftIcon={
                                      <Img
                                        src="images/img_icon_archive.svg"
                                  ...
                                  >
                                    <div className="bg-transparent cursor-pointer font-normal not-italic text-[12px] text-left text-white_A700 w-[100%]">
                                      Archive
                                    </div>
                                  </Button>
                                </div>
                              ...
                              <div className="flex flex-col items-center justify-start w-[51%]">
                                <div className="flex flex-col items-center justify-start w-[100%]">
                                  <Button
                                    ...
                                    variant="FillGray202"
                                  >
                                    <div className="bg-transparent cursor-pointer font-normal not-italic text-[12px] text-gray_900_a2 text-left w-[100%]">
                                      Snooze
                                    </div>
                                  </Button>
                                </div>
                        ...
                        <div className="bg-white_A700 border border-gray_900_14 border-solid flex flex-col items-start justify-end p-[7px] w-[100%]">
                          <div className="flex flex-row gap-[8px] items-center justify-start md:ml-[0] sm:ml-[0] ml-[11px] mr-[auto] w-[auto]">
                            <Img
                              src="images/img_search.svg"
                              className="h-[16px] w-[16px]"
                              alt="search Five"
                    ...
                    <div className="flex flex-row gap-[12px] items-start justify-end ml-[auto] md:w-[100%] sm:w-[100%] w-[93%]">
                      <List
                        className="flex-col gap-[12px] grid h-[567px] items-start w-[auto]"
                        orientation="vertical"
                      >
                          ...
                          <div className="flex flex-col items-start justify-start w-[auto]">
                            <div className="flex flex-col items-center justify-start w-[100%]">
                              ...
                              <div className="bg-deep_purple_52 flex flex-col h-[24px] md:h-[auto] sm:h-[auto] items-start justify-start px-[8px] py-[4px] rounded-bl-[8px] rounded-br-[8px] rounded-tl-[0] rounded-tr-[0] w-[257px]">
                                <div className="flex flex-row gap-[4px] items-center justify-center w-[auto]">
                                  <Img
                                    src="images/img_ellipse47_16x16.png"
                                  ...
                                  <Text
                                    ...
                                    variant="body2"
                                  >
                                    <span className="text-gray_900_99 text-[11px] font-inter font-normal not-italic">
                                      Archived in
                                    </span>
                                    <span className="text-gray_900_99 text-[11px] font-inter">
                                      {" "}
                                    </span>
                                    <span className="text-gray_900 text-[11px] font-inter">
                                      Completed{" "}
                                    </span>
                                    <span className="text-gray_900_99 text-[11px] font-inter font-normal not-italic">
                                      3 days ago
                        ...
                        <div className="flex flex-col items-center justify-end my-[0] w-[100%]">
                          <div className="flex flex-col items-start justify-start w-[auto]">
                            <div className="flex flex-col items-center justify-start w-[100%]">
                              <div className="bg-white_A700 flex flex-col items-start justify-center rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] w-[257px]">
                                <div className="flex flex-col items-start justify-center p-[8px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] md:self-stretch sm:self-stretch w-[100%]">
                                  <div className="flex flex-col gap-[8px] items-start justify-start self-stretch w-[100%]">
                                    <div className="flex flex-col items-start justify-center self-stretch w-[100%]">
                                      <div className="flex flex-row gap-[8px] items-start justify-start w-[auto]">
                                        <Img
                              ...
                              <div className="bg-deep_purple_52 flex flex-col h-[24px] md:h-[auto] sm:h-[auto] items-start justify-start px-[8px] py-[4px] rounded-bl-[8px] rounded-br-[8px] rounded-tl-[0] rounded-tr-[0] w-[257px]">
                                <div className="flex flex-row gap-[4px] items-center justify-center w-[auto]">
                                  <Img
                                    src="images/img_ellipse47_16x16.png"
                                    className="h-[16px] md:h-[auto] sm:h-[auto] rounded-radius50 w-[16px]"
                                    alt="EllipseFortySeven One Four"
                                  />
                                  <Text
                                    className="font-medium text-gray_900 text-left w-[auto]"
                                    variant="body2"
                              ...
                              <div className="bg-deep_purple_52 flex flex-col h-[24px] md:h-[auto] sm:h-[auto] items-start justify-start px-[8px] py-[4px] rounded-bl-[8px] rounded-br-[8px] rounded-tl-[0] rounded-tr-[0] w-[257px]">
                                <div className="flex flex-row gap-[4px] items-center justify-center w-[auto]">
                                  <Img
                                    src="images/img_ellipse47_16x16.png"
                                    className="h-[16px] md:h-[auto] sm:h-[auto] rounded-radius50 w-[16px]"
                                    alt="EllipseFortySeven One Five"
                                  />
                                  <Text
                                    className="font-medium text-gray_900 text-left w-[auto]"
                                    variant="body2"
                      ...
                      <Line className="bg-gray_900_19 h-[124px] mb-[406px] mt-[37px] rounded-radius2 w-[4px]" />
                    </div>
                  </div>
                </div>
              </Stack>
...
export default ArchivedCardPopupPage;
