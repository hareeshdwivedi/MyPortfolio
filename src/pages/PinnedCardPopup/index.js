          ...
          <div className="flex flex-col items-center justify-start md:pl-[20px] sm:pl-[20px] md:pr-[20px] sm:pr-[20px] md:w-[100%] sm:w-[100%] w-[82%]">
            ...
            <Stack className="h-[918px] relative w-[100%]">
              ...
              <Stack className="absolute h-[918px] inset-[0] justify-center m-[auto] w-[100%]">
                                ...
                                <div className="bg-white_A700 flex flex-col items-start justify-center w-[192px]">
                                  <div className="flex flex-col gap-[2px] items-start justify-center p-[8px] md:self-stretch sm:self-stretch w-[100%]">
                                    ...
                                    <div className="flex flex-col gap-[8px] items-start justify-start self-stretch w-[100%]">
                                      ...
                                      <div className="flex flex-row gap-[4px] items-start justify-start w-[auto]">
                                        <div className="bg-orange_50 flex flex-col items-start justify-center pb-[2px] px-[4px] w-[auto]">
                                          <Text
                                      ...
                                      <div className="flex flex-row items-center justify-between self-stretch w-[100%]">
                                        <div className="bg-gray_900_14 flex flex-col items-center justify-center px-[4px] py-[2px] w-[auto]">
                                          <Text
                                            className="font-medium text-gray_900_87 text-left w-[auto]"
                                            variant="body3"
                                          >
                ...
                <div className="absolute bg-bluegray_50 border border-gray_900_19 border-solid flex flex-col items-center justify-start right-[29%] rounded-radius8 shadow-bs top-[7%] w-[26%]">
                  <div className="flex flex-col gap-[16px] items-end justify-start w-[100%]">
                    <div className="bg-white_A700 flex flex-col items-center justify-start pt-[15px] rounded-bl-[0] rounded-br-[0] rounded-tl-[7px] rounded-tr-[7px] w-[100%]">
                      <div className="flex flex-col gap-[16px] items-center justify-start w-[100%]">
                        <div className="flex flex-row items-center justify-between w-[257px]">
                          <div className="flex flex-row gap-[4px] items-center justify-start w-[auto]">
                            <Img
                              src="images/img_airplane.svg"
                              className="h-[20px] w-[20px]"
                        ...
                        <div className="flex flex-col items-center justify-start w-[100%]">
                          ...
                          <Input
                            ...
                            className="font-normal not-italic p-[0] text-[13px] placeholder:text-gray_900_7e text-gray_900_7e text-left w-[100%]"
                    ...
                    <div className="flex flex-row gap-[12px] items-start justify-end ml-[auto] md:w-[100%] sm:w-[100%] w-[93%]">
                      ...
                      >
                        <div className="flex flex-col items-center justify-start my-[0] w-[100%]">
                          <div className="flex flex-col items-start justify-start w-[auto]">
                            <div className="flex flex-col items-center justify-start w-[100%]">
                              <div className="bg-white_A700 flex flex-col items-start justify-center rounded-radius8 w-[257px]">
                                <div className="flex flex-col gap-[2px] items-start justify-center p-[8px] rounded-radius8 md:self-stretch sm:self-stretch w-[100%]">
                                  <div className="flex flex-col justify-center self-stretch w-[100%]">
                                    <div className="flex flex-row gap-[4px] items-center justify-start w-[auto]">
                                      <div className="bg-pink_A200 h-[6px] rounded-radius50 w-[6px]"></div>
                        ...
                        <div className="flex flex-col items-center justify-end my-[0] w-[100%]">
                          <div className="flex flex-col items-start justify-start w-[auto]">
                            <div className="flex flex-col items-center justify-start w-[100%]">
                              <div className="bg-white_A700 flex flex-col items-start justify-center rounded-radius8 w-[257px]">
                                <div className="flex flex-col items-start justify-center p-[8px] rounded-radius8 md:self-stretch sm:self-stretch w-[100%]">
                                  <div className="flex flex-col gap-[8px] items-start justify-start self-stretch w-[100%]">
                                    <div className="flex flex-col items-start justify-center self-stretch w-[100%]">
                                      <div className="flex flex-row gap-[8px] items-start justify-start w-[auto]">
                                        <Img
                      ...
                      <Line className="bg-gray_900_19 h-[150px] mb-[417px] rounded-radius2 w-[4px]" />
                    </div>
                  </div>
                </div>
              </Stack>
...
export default PinnedCardPopupPage;
