...
import { Img, Text, Line, Button, Input, Stack, List } from "components";
import { CloseSVG } from "../../assets/images/index.js";

const ListActionsSortbypPage = () => {
          ...
          <div className="flex flex-col items-center justify-start md:pl-[20px] sm:pl-[20px] md:pr-[20px] sm:pr-[20px] md:w-[100%] sm:w-[100%] w-[82%]">
            ...
            <Stack className="h-[918px] relative w-[100%]">
              ...
              <Stack className="absolute h-[918px] inset-[0] justify-center m-[auto] w-[100%]">
                <Stack className="h-[918px] m-[auto] w-[100%]">
                  <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-[auto] top-[0] w-[100%]">
                    <div className="flex flex-col gap-[24px] items-center justify-start w-[100%]">
                      ...
                      <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-start md:w-[100%] sm:w-[100%] w-[96%]">
                        <div className="bg-deep_purple_50 flex flex-col gap-[8px] items-center justify-start mb-[369px] py-[8px] rounded-radius8 w-[auto]">
                        ...
                        <div className="bg-deep_purple_51 flex flex-col gap-[8px] items-center justify-start md:ml-[0] sm:ml-[0] ml-[456px] py-[8px] rounded-radius8 w-[auto]">
                          <div className="flex flex-row items-center justify-between w-[192px]">
                            <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                              <Text
                                className="font-semibold text-gray_900 text-left w-[auto]"
                        ...
                        <div className="bg-deep_purple_51 flex flex-col gap-[8px] items-center justify-start mb-[534px] md:ml-[0] sm:ml-[0] ml-[8px] py-[8px] rounded-radius8 w-[auto]">
                          <div className="flex flex-row items-center justify-between w-[192px]">
                            <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                              <Text
                                className="font-semibold text-gray_900 text-left w-[auto]"
                  ...
                  <div className="absolute bg-deep_purple_51 flex flex-col gap-[8px] items-center justify-start left-[22%] py-[8px] rounded-radius8 top-[10%] w-[auto]">
                    <div className="flex flex-row items-center justify-between w-[192px]">
                      <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                        <Text
                          className="font-semibold text-gray_900 text-left w-[auto]"
                  ...
                  <div className="absolute bg-deep_purple_51 bottom-[0] flex flex-col inset-x-[0] items-center justify-start mx-[auto] rounded-radius8 w-[19%]">
                    <Stack className="bg-deep_purple_51 h-[826px] md:h-[auto] sm:h-[auto] py-[8px] relative rounded-radius8 w-[216px]">
                      <Stack className="bg-deep_purple_51 h-[826px] md:h-[auto] sm:h-[auto] m-[auto] py-[8px] rounded-radius8 w-[216px]">
                        ...
                        <div className="absolute bg-deep_purple_51 flex flex-col h-[34px] md:h-[auto] sm:h-[auto] inset-x-[0] items-center justify-end mx-[auto] px-[12px] py-[8px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] top-[0] w-[auto]">
                          <div className="flex flex-row items-center justify-between w-[192px]">
                            <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                              <Text
                                className="font-semibold text-gray_900 text-left w-[auto]"
                      ...
                      <div className="absolute bottom-[0] flex flex-col gap-[8px] inset-x-[0] items-center justify-start mx-[auto] w-[auto]">
                        ...
                        <div className="flex flex-col items-center justify-start w-[100%]">
                          <Stack className="h-[55px] px-[8px] relative w-[216px]">
                            ...
                            <div className="absolute bg-deep_purple_51 bottom-[0] flex flex-col h-[50px] md:h-[auto] sm:h-[auto] inset-x-[0] items-center justify-start mx-[auto] px-[12px] py-[8px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] w-[216px]">
                ...
                <div className="absolute flex sm:flex-col flex-row sm:gap-[40px] items-start justify-between right-[3%] top-[6%] w-[60%]">
                  <div className="flex flex-col items-center justify-start sm:mt-[0] mt-[63px] md:w-[100%] sm:w-[100%] w-[45%]">
                    <Stack className="h-[157px] relative w-[100%]">
                      <div className="absolute bg-white_A700 border border-gray_900_19 border-solid flex flex-col gap-[16px] h-[max-content] inset-y-[0] items-center justify-start left-[0] my-[auto] rounded-radius8 shadow-bs w-[89%]">
                        <div className="flex flex-row gap-[140px] items-center justify-between mt-[15px] w-[auto]">
                          <Text
                        ...
                        <Img
                          ...
                          className="h-[1px] mb-[104px] w-[auto]"
                          alt="Group258"
                        />
                      </div>
                      <div className="absolute bottom-[13%] flex flex-col gap-[4px] inset-x-[0] items-center justify-start mx-[auto] w-[auto]">
                        <div className="flex flex-col items-start justify-center px-[20px] py-[8px] w-[307px]">
                          <Text
                  ...
                  <div className="bg-white_A700 border border-gray_900_19 border-solid flex flex-col gap-[9px] items-center justify-start rounded-radius8 shadow-bs md:w-[100%] sm:w-[100%] w-[35%]">
                    <div className="bg-white_A700 border border-gray_900_19 border-solid flex flex-col items-center justify-start p-[15px] rounded-bl-[0] rounded-br-[0] rounded-tl-[7px] rounded-tr-[7px] w-[100%]">
                      <div className="flex flex-row items-center justify-between w-[208px]">
                    ...
                    <div className="flex flex-col gap-[4px] items-start justify-start mb-[11px] w-[auto]">
                      <Input
                        className="font-normal not-italic p-[0] text-[13px] placeholder:text-gray_900_99 text-gray_900_99 text-left w-[100%]"
                        wrapClassName="w-[238px]"
                        name="Frame5924"
                        placeholder="Order"
                        size="xl"
                        variant="FillGray9000a"
                      ></Input>
                      <div className="flex flex-col items-start justify-center px-[15px] py-[8px] w-[238px]">
                        <Text
                          className="font-normal not-italic text-gray_900_99 text-left w-[auto]"
                          as="h6"
                          variant="h6"
...
export default ListActionsSortbypPage;
