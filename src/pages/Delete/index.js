    ...
    <>
      <Stack className="bg-gray_50 font-inter h-[1024px] mx-[auto] overflow-auto relative w-[100%]">
        <Stack className="absolute bottom-[0] h-[1529px] inset-x-[0] mx-[auto] w-[100%]">
          ...
          <div className="absolute bg-gray_900_87 flex flex-col inset-x-[0] items-center justify-start mx-[auto] p-[388px] sm:px-[20px] md:px-[40px] top-[0] w-[100%]">
            <div className="flex flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[75%]">
              <div className="flex flex-col items-center justify-start w-[100%]">
                <div className="bg-white_A700 flex flex-col gap-[19px] justify-start py-[20px] rounded-radius8 shadow-bs2 w-[100%]">
                  <div className="flex flex-col gap-[20px] items-center justify-start w-[100%]">
                    <div className="flex flex-row items-center justify-between sm:w-[100%] w-[444px]">
                      <div className="flex flex-col items-start justify-center w-[auto]">
                        <Text
                          className="text-gray_900 text-left w-[auto]"
                          as="h2"
                    ...
                    <div className="flex flex-col items-start justify-start w-[100%]">
                      ...
                      <div className="flex flex-col items-start justify-start md:ml-[0] sm:ml-[0] ml-[24px] mt-[19px] w-[auto]">
                      ...
                      <Line className="bg-gray_900_19 h-[1px] mt-[54px] w-[100%]" />
                    </div>
                  </div>
                  <div className="flex flex-row gap-[12px] items-start justify-start mb-[4px] ml-[auto] w-[auto]">
                    <Button
                      className="cursor-pointer font-medium min-w-[91px] text-[13px] text-center text-gray_900_a2 w-[auto]"
                    ...
                    <Button
                      className="cursor-pointer font-medium min-w-[89px] text-[13px] text-center text-white_A700 w-[auto]"
                      shape="RoundedBorder8"
                      size="2xl"
